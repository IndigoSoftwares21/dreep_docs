...
## 4. Audio & Thumbnail Extraction

Because they do not require a full video re-encode, Dreep can extract thumbnails and audio tracks from your video assets at lightning speeds (often returning in under 200ms).
...
_(You can also use `.jpg` or `format=jpg` interchangeably with `jpeg`!)_
